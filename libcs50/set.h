 ...
 * any given key can only occur in the set once. It starts out empty and 
 * grows as the caller inserts new (key,item) pairs. The caller can 
 * retrieve items by asking for their key, but cannot remove or update pairs. 
